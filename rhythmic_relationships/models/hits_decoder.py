...
class TransformerDecoder(nn.Module):
    def __init__(self, vocab_size, n_embed, context_len, n_head, n_layer, dropout, pad_ix):
        super().__init__()
        ...
        self.token_embedding_table = nn.Embedding(vocab_size, n_embed, padding_idx=pad_ix)
        self.position_embedding_table = nn.Embedding(context_len, n_embed, padding_idx=pad_ix)
